            ...
            <div className="flex flex-col items-start justify-between h-full w-full">
                <div className="flex w-full space-x-4">
                    <div className="w-8/12 bg-white shadow-lg">
                        ...
                        <div className="flex flex-row pt-6 pb-4 w-full">
                            {/* right column */}
                            <div className="px-4 w-[150rem] bg-red-500">
                                <p className="text-gray-500 font-semibold text-lg">This Month</p>
                                <h2 className="text-xl font-bold pt-4 text-gray-600">245,758 Litres</h2>
                                ...
                                <h2 className="text-xl font-bold text-gray-500">200,981 Litres</h2>
                            </div>
                            {/* atm stats */}
